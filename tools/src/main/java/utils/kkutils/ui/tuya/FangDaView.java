...
public class FangDaView extends View {
    ...
    public FangDaView(Builder builder, Context context) {//对象初始化一次就行了
        super(context);
    ...
    public FangDaView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public FangDaView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if(activity!=null && rootVg!=null && this.getParent()==null)//getParent()防止当前控件没有加入别的父
        {
            ...
            viewTreeObserver.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                ...
                public void onGlobalLayout() {
                    if(bm==null) {
                        //初始化控件位置
                        FangDaView.this.setX(initLeft);
                        FangDaView.this.setY(initTop);
    ...
    public static class Builder
    {
        ...
        public FangDaView build()
        {
            return new FangDaView(this,context);
        }
    }
