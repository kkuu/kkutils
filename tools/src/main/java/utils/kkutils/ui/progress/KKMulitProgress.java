...
public class KKMulitProgress extends View {
    ...
    public KKMulitProgress(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        init();
    }

    public void setListProgress(List<MulitProgressData> listProgress) {
    ...
    //进度条颜色
    public int colorProgress= Color.parseColor("#dac7b7");
    //背景色
    public int colorBackground= Color.parseColor("#f5f5f5");
    //最小刻度
