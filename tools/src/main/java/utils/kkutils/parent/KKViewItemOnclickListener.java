...
public abstract class KKViewItemOnclickListener implements View.OnClickListener {
    ...
    public KKViewItemOnclickListener(boolean allowQuickClick){
        setAllowQuickClick(allowQuickClick);
    }
    public KKViewItemOnclickListener(){
    }
    /***
     * 是否允许快速点击
